...
namespace FxCommonLib.Utils {
    /// <summary>
    /// SQLite接続(ADO.Net)ユーティリティ
    /// </summary>
    public class SQLiteDBUtil : IDisposable {
        ...
        /// </summary>
        /// <remarks></remarks>
        public SQLiteDBUtil(ILog logger) {
            _logger = logger;
        }
        ...
        /// <remarks></remarks>
        public int ExecuteNonQuery(string sql, SQLiteParameter[] param, CommandType cmdType = CommandType.Text, int timeout = 60) {
            try {
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public DataSet ExecSelect(string sql, SQLiteParameter[] param = null, int maxRow = 0, string maxErrMsg = "", int timeout = 60) {
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public SQLiteDataReader ExecuteReader(string sql, SQLiteParameter[] param, CommandType cmdType = CommandType.Text, int timeout = 60) {
            _cmd = new SQLiteCommand();
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public static string ParamToString(SQLiteParameter[] param) {
